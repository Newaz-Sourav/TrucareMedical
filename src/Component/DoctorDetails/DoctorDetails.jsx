...
const DoctorDetails=()=>{
    ...
    return(
        <div class="flex flex-col justify-center gap-4 p-4 sm:flex-col sm:gap-4 sm:p-4 md:flex-col md:gap-4 md:p-6 lg:flex-row lg:gap-4 lg:p-4 xl:flex-row xl:gap-6 xl:p-8 2xl:flex-row 2xl:gap-6 2xl:p-14">
            <div class="w-full">
                <img class="w-full h-5/6 rounded-xl" src={doctor.img} alt="" />
            </div>
