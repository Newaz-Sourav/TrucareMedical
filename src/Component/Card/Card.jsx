...
const Card=(props)=>{
    ...
    const {id,name,img,Designation,fee}=props.item;
    ...
    <div class="p-5">
        ...
        <div >
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{Designation}</h5>
        </div>

        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">BDT: {fee}</p>
